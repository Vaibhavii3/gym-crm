...
// const calculateRenewalDate = (joiningDateString, subscriptionType) => {
//   if (!joiningDateString) return 'Unknown';
  
//   const joinDate = new Date(joiningDateString);
//   if (!isValid(joinDate)) return 'Invalid date';
...
//         />
//         <ClientInfo>
//           <ClientName>{client.name || 'Unknown Client'}</ClientName>
//           <StatusBadge status={client.status || 'inactive'}>
//             {client.status || 'inactive'}
//           </StatusBadge>
//           <JoinDate>
//             Member since {formatDate(client.joiningDate)}
//           </JoinDate>
//         </ClientInfo>
//       </Header>
...
//           <DetailItem>
//             <DetailLabel>Age:</DetailLabel>
//             <DetailValue>{client.age ? `${client.age} years` : 'Not provided'}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Date of Birth:</DetailLabel>
//             <DetailValue>{formatDate(client.dob)}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Weight:</DetailLabel>
//             <DetailValue>{client.weight ? `${client.weight} kg` : 'Not provided'}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Phone:</DetailLabel>
...
//           <DetailItem>
//             <DetailLabel>Address:</DetailLabel>
//             <DetailValue>{client.address || 'Not provided'}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Aadhar Number:</DetailLabel>
//             <DetailValue>{client.aadharNumber || 'Not provided'}</DetailValue>
//           </DetailItem>
//         </DetailSection>
...
//           <DetailItem>
//             <DetailLabel>Subscription:</DetailLabel>
//             <DetailValue>{client.subscriptionType || 'Not specified'}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Personal Trainer:</DetailLabel>
//             <DetailValue>{client.personalTrainer || 'None'}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Status:</DetailLabel>
...
//             <DetailLabel>Renewal Date:</DetailLabel>
//             <DetailValue>
//               {calculateRenewalDate(client.joiningDate, client.subscriptionType)}
//             </DetailValue>
//           </DetailItem>
//         </DetailSection>
//       </DetailGrid>
...
// // Helper function to calculate renewal date based on end date or start date
// const getEndDate = (client) => {
//   // If we have an end date directly, use it
//   if (client.membershipEndDate) {
//     return formatDate(client.membershipEndDate);
//   }
  
//   // If no end date but we have a start date, calculate based on membership type
//   if (client.membershipStartDate) {
//     const startDate = new Date(client.membershipStartDate);
//     if (!isValid(startDate)) return 'Unknown';
...
//           <DetailItem>
//             <DetailLabel>Age:</DetailLabel>
//             <DetailValue>{client.birthday ? calculateAge(client.birthday) : 'Not provided'}</DetailValue>
//           </DetailItem>
//           <DetailItem>
//             <DetailLabel>Date of Birth:</DetailLabel>
...
//             <DetailValue>{getEndDate(client)}</DetailValue>
//           </DetailItem>
//         </DetailSection>
//       </DetailGrid>
...
//           <DetailValue>{client.totalPaid ? `₹${client.totalPaid}` : '₹0'}</DetailValue>
//         </DetailItem>
//         <DetailItem>
//           <DetailLabel>Due Amount:</DetailLabel>
//           <DetailValue>{client.dueAmount ? `₹${client.dueAmount}` : '₹0'}</DetailValue>
//         </DetailItem>
//       </DetailSection>
//     </DetailContainer>
//   )
...
const ClientDetail = ({ client }) => {
  ...
  return (
    <DetailContainer>
      ...
      {/* Metadata section for database fields */}
      {/* <MetadataSection>
        <MetadataTitle>System Information</MetadataTitle>
        <MetadataGrid>
          <MetadataItem>
            <MetadataLabel>Created:</MetadataLabel>
            <MetadataValue>{client.createdAt ? formatDateTime(client.createdAt) : 'N/A'}</MetadataValue>
          </MetadataItem>
          <MetadataItem>
            <MetadataLabel>Updated:</MetadataLabel>
            <MetadataValue>{client.updatedAt ? formatDateTime(client.updatedAt) : 'N/A'}</MetadataValue>
          </MetadataItem>
          <MetadataItem>
            <MetadataLabel>Client ID:</MetadataLabel>
            <MetadataValue>{client._id}</MetadataValue>
          </MetadataItem>
        </MetadataGrid>
      </MetadataSection> */}
    </DetailContainer>
